...
## Project Structure
    ...
    ├── testapiautosetting_127061  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127061`
...
2. Clone this repo and `cd testapiautosetting_127061`
